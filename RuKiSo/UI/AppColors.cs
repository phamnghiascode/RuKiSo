namespace RuKiSo.UI
{
    ...
    {
        public static readonly Color PrimaryColor = Color.FromArgb("#f2ae26");
        public static readonly Color SecondaryColor = Color.FromArgb("#343C6A");
        public static readonly Color PrimaryBackGround = Color.FromArgb("#F5F7FA");
